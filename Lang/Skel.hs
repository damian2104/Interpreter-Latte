...
transProgram x = case x of
  Program alldefs -> failure x
transAllDef :: AllDef -> Result
transAllDef x = case x of
  FunDef topdef -> failure x
  VarDef topvar -> failure x
transTopVar :: TopVar -> Result
transTopVar x = case x of
